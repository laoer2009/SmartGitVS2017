...
namespace NewsPublish.Web
{
    public  class RedisHelper
    {
        ...
        private IOptions<RedisConfig> _redisConfig;
        ...
        static RedisHelper()
        {
            _connMultiplexer = GetConnectionMultiplexer();
            //_connMultiplexer = ConnectionMultiplexer.Connect(EnvironmentInfo.ConnectionString);
        ...
        {
            return $"{EnvironmentInfo.DefaultKey}:{key}";
        }
        ...
        public static T Deserialize<T>(byte[] data)
        {
            ...
            {
                var result = (T)binaryFormatter.Deserialize(memory);
                return result;
            }
        ...
        public bool StringSet(string redisKey, string redisValue, TimeSpan? expried = null)
        {
            ...
            return _db.StringSet(redisKey, redisKey, expried);
        }
        /// <summary>
        /// 保存多个key-value
        /// </summary>
        /// <param name="keyValuesPairs"></param>
        /// <returns></returns>
        public bool StringSet(IEnumerable<KeyValuePair<RedisKey, RedisValue>> keyValuesPairs)
        {
            keyValuesPairs =
                keyValuesPairs.Select(x => new KeyValuePair<RedisKey, RedisValue>(AddKeyPrefix(x.Key), x.Value));
            return _db.StringSet(keyValuesPairs.ToArray());
        }
        ...
        /// </summary>
        /// <param name="redisKey"></param>
        /// <param name="hashFied"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        public bool HashSet(string redisKey, string hashFied, string value)
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.HashSet(redisKey, hashFied, value);
        }
        ...
        #region list operation Ctrl+M,M快速折叠  
        //https://www.xin3721.com/ArticlecSharp/c12543.html  list 存储对象类型
        /// <summary>
        /// 移除并返回key所对应列表的第一个元素
        /// </summary>
        /// <param name="redisKey"></param>
